...
week2_res <- read.csv(SEDM_vs_SEEM_input)
gene_mapping_week2 <- data.frame(Transcript_id = week2_res[["X"]])
...
week4_res <- read.csv(A687_vs_Nalm6_input)
gene_names_A687_24hr_vs_Nalm6_0hr <- data.frame(gene_name = week4_res[["X"]])
